...
var index = () => {
    ...
    class ArcTextEditor {
        constructor(el, options) {
            ...
            this.$el = el;
            // 创建fabric画布
            this.canvas = new fabric.Canvas(el, Object.assign(Object.assign({}, options), { selection: false, preserveObjectStacking: true }));
        ...
        rebuildOperationElements(reuse = false) {
            ...
            path === null || path === void 0 ? void 0 : path.forEach((item, pathIdx) => {
                ...
                for (let i = 0; i < croods.length; i += 2) {
                    ...
                    // 创建操作点
                    const point = (_a = (reuse ? this.points.pop() : undefined)) !== null && _a !== void 0 ? _a : new fabric.Circle({
                        strokeWidth: 4,
                        radius: 6,
                        fill: "#ffffff",
                        stroke: "#4b4b4b",
